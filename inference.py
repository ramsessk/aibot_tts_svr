...
def parse_args():
    ...
    parser.add_argument(
        "--total-step", type=int, default=4, help="Number of denoising steps, default=4"
    )
    parser.add_argument(
        "--speed",
        type=float,
        default=1.01,
        help="Speech speed (default: 1.01, higher = faster)",
    )
    parser.add_argument(
        "--n-test", type=int, default=1, help="Number of times to generate, default=1"
    )
    ...
    parser.add_argument(
        "--save-dir", type=str, default="/tmp", help="Output directory"
    )
    parser.add_argument(
        "--output", type=str, default="tts_output", help="Output filename, default=tts_output_1.wav"
    )
